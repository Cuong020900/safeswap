  ...
  return (
	...
	href='#'
      ...
      <div className="consolidate-intro">
        ...
        <h3 className="consolidate-intro-heading">What is V2 SafeMoon? <span role='img'>❗️❓</span></h3>
        ...
        <h3 className="consolidate-intro-heading">What will I need to do? <span role='img'>🤔</span></h3>
        <p className="consolidate-intro-text">
